...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Back in the early 2000s, I was obsessed with an application called 'Games Factory'. It was a simple game creation tool that let you build 2D games with a drag-and-drop interface. I spent hours building small silly games with simple graphics. One of my favorite creations was a top-down arena shooter where you played 1v2 as a powerful predator against two agile guardians. Me and my friends loved to play this together, sharing the same keyboard and a single monitor. I've always wanted to revisit that concept and build a modern version of it. Fast forward to today, Banger is the result - the multiplayer arena shooter with the original 1v2 gameplay, but now playable over the internet.",
    features: [
